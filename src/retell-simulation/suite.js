const BASE_VARIABLES = Object.freeze({
  ...
  homeownerPhoneForSpeech: "two zero two - five five five - zero one zero zero",
  homeownerEmail: "jordan@example.test",
  carrier: "Example Mutual",
  policyNumber: "EX-123456",
  policyNumberSpoken: "EX-123456",
  policyNumberForSpeech: "E X - one two three four five six",
  claimNumber: "Missing",
  claimNumberForSpeech: "Missing",
  dateOfLoss: "06/02/2026",
  dateOfLossForSpeech: "June second, twenty twenty six",
  stormTime: "Evening",
  ...
  contractorPhoneForSpeech: "Missing",
  ...
  callbackPolicyNumberForSpeech: "Missing",
  callbackClaimNumber: "Missing",
  callbackClaimNumberForSpeech: "Missing",
