...
import { buildRetellLlmFromPacket, renderRetellPrompt, postCallAnalysisSchema } from "../claim-filing-core/index.js";

const RETELL_API_BASE = "https://api.retellai.com";

// Re-export the portable prompt/tools/schema so existing importers keep working.
export { buildRetellLlmFromPacket, renderRetellPrompt, postCallAnalysisSchema } from "../claim-filing-core/index.js";
